...
public class CartsController {
    ...
    @GetMapping("/generate")
    @Operation(
            summary = "Создание корзины гостя",
            responses = {
                    @ApiResponse(
                            description = "Успешный ответ", responseCode = "200",
                            content = @Content(schema = @Schema(implementation = CartDto.class))
    ...
    @Operation(
            summary = "Добавить продукт с определенным ID в корзину пользователя",
            responses = {
                    @ApiResponse(
                            description = "Успешный ответ", responseCode = "200",
                            content = @Content(schema = @Schema(implementation = CartDto.class))
    ...
    @Operation(
            summary = "Уменьшение количества продукта с определенным ID в корзине пользователя",
            responses = {
                    @ApiResponse(
                            description = "Успешный ответ", responseCode = "200",
                            content = @Content(schema = @Schema(implementation = CartDto.class))
    ...
    @Operation(
            summary = "Удаление продукта по ID в корзине пользователя",
            responses = {
                    @ApiResponse(
                            description = "Успешный ответ", responseCode = "200",
                            content = @Content(schema = @Schema(implementation = CartDto.class))
    ...
    @Operation(
            summary = "Удаление корзины пользователя",
            responses = {
                    @ApiResponse(
                            description = "Успешный ответ", responseCode = "200",
                            content = @Content(schema = @Schema(implementation = CartDto.class))
    ...
    @Operation(
            summary = "Слияние корзины гостя и пользователя",
            responses = {
                    @ApiResponse(
                            description = "Успешный ответ", responseCode = "200",
                            content = @Content(schema = @Schema(implementation = CartDto.class))
